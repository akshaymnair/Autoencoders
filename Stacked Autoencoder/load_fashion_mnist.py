...
# datasets_dir = 'C:\\Users\\amit1\\Documents\\python-workspace\\FSL_Project'
...
def load_fashion_mnist(noTrSamples=60000, noTsSamples=10000, \
...
def main():
    trX, trY, tsX, tsY = load_fashion_mnist(noTrSamples=2000,
